...
import fr.maygo.uhc.modes.naruto.v2.gui.chibakutensei.ChibakuTenseiGUI;
    ...
    public ChibakuTenseiItem(UhcHost main) {
        ...
        super.onClick(onClick -> {
            ...
            if (PlayerManager.hasRole()) {
                if (PlayerManager.getRole() instanceof ChibakuTenseiUser) {
                    ChibakuTenseiUser chibakuTenseiUser = (ChibakuTenseiUser) PlayerManager.getRole();
