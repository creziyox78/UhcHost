...
import fr.atlantis.api.utils.raytracing.BoundingBox;
import fr.atlantis.api.utils.raytracing.RayTrace;
    ...
    public Player getTargetPlayer(Player player, double distanceMax) {
        ...
        for (int i = 0; i < positions.size(); i++) {
            ...
            for (Entity entity : entities) {
                if (entity instanceof Player && entity != player && rayTrace.intersects(new BoundingBox(entity), distanceMax, 0.05D))
