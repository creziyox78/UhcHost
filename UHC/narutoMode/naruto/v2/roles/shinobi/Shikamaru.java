...
import fr.atlantis.api.display.PacketDisplay;
import fr.atlantis.api.item.crafter.QuickItem;
import fr.atlantis.api.utils.WorldUtils;
import fr.maygo.uhc.enums.Messages;
import fr.maygo.uhc.enums.WorldState;
...
import fr.maygo.uhc.modes.naruto.v2.items.IntonItem;
...
public class Shikamaru extends Role implements NarutoV2Role, RoleListener {
    ...
    public void checkRunnable(Player player) {
        ...
        inOeil.forEach((uuid, armorStand) -> {
            ...
            PlayerManager PlayerManager = main.getPlayerManager(uuid);
            if (target == null && armorStand.isCustomNameVisible() && !PlayerManager.isAlive())
                armorStand.setCustomNameVisible(false, player);
        });
    }
    ...
    public double getPlayersDistance() {
        return main.getWorldState() == WorldState.DAY ? 15 : 30;
    }
