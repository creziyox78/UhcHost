...
import fr.maygo.uhc.modes.naruto.v2.items.HyotonItem;
...
public class Haku extends Role implements NarutoV2Role, RoleListener {
                    ...
                    if (target.getHealth() <= 4 * 2D) {
                        if (super.getPlayer() != null) {
                            new ClickableMessage(super.getPlayer(), onClickMessage -> {
                                if (target != null && PlayerManager.isAlive()) {
    ...
    public String getDescription() {
        return this.main.getUHCDatabase().getRoleDescription(this.getClass());
    }
