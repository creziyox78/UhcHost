...
public class OresMinYGui extends IQuickInventory {

    private final BlocksRule rule;
    private BannerCreator bc;

    public OresMinYGui(BlocksRule rule) {
    ...
    public void contents(QuickInventory inv) {
        inv.updateItem("update", taskUpdate -> {
            ...
            inv.setItem(bc.create(), onClick -> {
                ...
                int value = this.rule.minY + Integer.parseInt(bannerName);
                if (value < 0)
                    return;
                this.rule.minY = value;
            }, 0);
            ...
            ItemsCreator ic = new ItemsCreator(Material.BEDROCK, "§e" + this.rule.minY,
                    Arrays.asList(""));
