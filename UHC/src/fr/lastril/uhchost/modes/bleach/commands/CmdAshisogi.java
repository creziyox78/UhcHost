...
public class CmdAshisogi implements ModeSubCommand {

    private final UhcHost main;

    public CmdAshisogi(UhcHost main) {
        this.main = main;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if(playerManager.getRole() instanceof Mayuri){
            ...
            if(bleachPlayerManager.canUsePower()){
                if(!mayuri.isSpawnedWither()){
                    mayuri.spawnWither(player);
                    mayuri.setSpawnedWither(true);
                }
            } else {
